...
public class MainDesign {
	...
	private void drawKeywordButton() {
		keywordbtn = new Keywordbtn();
		frame.add(keywordbtn);
	}
	...
	public Keywordbtn getKeywordButton() {
		return this.keywordbtn;
	}
}
